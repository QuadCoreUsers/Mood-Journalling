...
SECRET_KEY = 'django-insecure-b_2lr54ufp8-*k+987d5nq0ld4bhu_oda0w$gkl95&843jxpww'
...
INSTALLED_APPS = [
    ...
    'corsheaders',     # CORS Headers for handling frontend-backend communication

    # Your custom app
    'journal',         # The app you created
]
